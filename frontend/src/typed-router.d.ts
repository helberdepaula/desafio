...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/fornecedoresNew': RouteRecordInfo<'/fornecedoresNew', '/fornecedoresNew', Record<never, never>, Record<never, never>>,
  ...
  export interface _RouteFileInfoMap {
    ...
    'src/pages/fornecedoresNew.vue': {
      routes: '/fornecedoresNew'
      views: never
    }
    'src/pages/login.vue': {
      routes: '/login'
